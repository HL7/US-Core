...
Instead of returning a search Bundle resource containing all the Encounter for the patient, the Server returns a `400 Not Found` and an OperationOutcome detailing that a status parameter is required for this search.
