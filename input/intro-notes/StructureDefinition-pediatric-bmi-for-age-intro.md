...
- Information about the growth chart tables used to determine percentiles **SHOULD** be supplied in `Observation.note.text` (for example, 'CDC Males, 2-20 years Chart').<sup>[§][CONF-0448]</sup>
