...
- <span class="bg-success" markdown="1">The DocumentReference Attestor R5 Extension replaces the R4 `DocumentReference.authenticator` to allow multiple authenticators, including patient attestation. The examples illustrate how this extension is used to represent patient and provider attestations for various ADI documents.</span><!-- new-content -->
