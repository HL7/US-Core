...
1.  the organization responsible for the document, referred to as custodian.
  ...
  Unless sufficient number of commenters request retention of MustSupport for this element (`DocumentReference.custodian`), it will change to Optional in the published version
  {:.note-to-balloters #FHIR-28393}
