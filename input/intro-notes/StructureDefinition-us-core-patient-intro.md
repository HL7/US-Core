...
- <span class="bg-success" markdown="1"><sup>1</sup>For new and updated records, [Certifying Systems] **SHALL** and non-Certifying Systems **SHOULD** enable the users who enter patient addresses to follow the [Project US@ Technical Specification for Patient Addresses Final Version 1.0], which is required by the USCDI Patient Demographics Data Class<sup>[§][CONF-0469],[§][CONF-0470]</sup></span><!-- new-content -->
   - Consult <span class="bg-success" markdown="1">this specification</span><!-- new-content --> for details about the format for the Address datatypes elements, especially `Patient.address.line` and `Patient.address.city`.
