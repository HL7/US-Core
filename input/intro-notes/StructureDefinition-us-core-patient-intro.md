...
- <span class="bg-success" markdown="1">Systems **SHOULD** follow the [Project US@ Technical Specification for Patient Addresses Final Version 1.0] as the standard style guide for `Patient.address.line` and  `Patient.address.city`.</span><!-- new-content -->
