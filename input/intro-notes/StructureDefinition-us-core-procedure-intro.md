...
- {:.new-content}This profile can be used to record a completed service or intervention. When exchanging Social Determinants of Health (SDOH) Procedures, servers **SHALL** use the [SDOH Procedure](https://vsac.nlm.nih.gov/valueset/2.16.840.1.113762.1.4.1196.789/expansion) concepts provided by Gravity. See [SDOH Guidance] for more information. 
