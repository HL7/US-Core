...
<!-- ================================================================
 The following Cross Version Comparison table is generated by liquid script below. The source table is input/data/profile-metadata.csv where edits to the table contents are made when new profile are added, deprecated, etc.
