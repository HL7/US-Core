...
60. **Triaged:** (Correction) new profiles are not listed in CapabilityStatement [FHIR-49162](https://jira.hl7.org/browse/FHIR-49162) See Changes [Here](CapabilityStatement-us-core-server.html)
...
72. **Triaged:** (Clarification) Fix ADI DocumentReference patient+category search requirement [FHIR-49250](https://jira.hl7.org/browse/FHIR-49250) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html#mandatory-search-parameters)
...
122. **Submitted:** () US Core Lab result profile should not be a Must Support target profile for DiagnosticReport.result in Report and Note profile [FHIR-49906](https://jira.hl7.org/browse/FHIR-49906) See Changes [Here]()
