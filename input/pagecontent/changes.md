...
5. **Applied** (Enhancement) Add SNOMED NUCC Mapping link to the PractionerRole page [FHIR-45286](https://jira.hl7.org/browse/FHIR-45286) [See Changes Here](StructureDefinition-us-core-practitionerrole.html)
...
7. **Applied:** (Clarification) Clarify Must Support requirements for requestors [FHIR-45448](https://jira.hl7.org/browse/FHIR-45448) [See Changes Here](must-support.html#must-support-elements)
8.  **Resolved - change required:** (Correction) Move ""time-period"" from Must Support to Must Have section in introduction. [FHIR-45726](https://jira.hl7.org/browse/FHIR-45726) [See Changes Here](#.html)
9.  **Resolved - change required:** (Clarification) Align the Sig description in the medication profile introductions. [FHIR-45951](https://jira.hl7.org/browse/FHIR-45951) [See Changes Here](#.html)
10. **Resolved - change required:** (Clarification) Derive composite search parameters for derived normal parameters [FHIR-46036](https://jira.hl7.org/browse/FHIR-46036) [See Changes Here](#.html)
11. **Resolved - change required:** (Correction) Procedure.code should be Procedure.performed [FHIR-46037](https://jira.hl7.org/browse/FHIR-46037) [See Changes Here](#.html)
12. **Resolved - change required:** (Correction) Incorrect Examples [FHIR-46099](https://jira.hl7.org/browse/FHIR-46099) [See Changes Here](#.html)
13. **Resolved - change required:** (Clarification) Clarify (reduce) the media.link requirements for DiagnosticReport (Report and Notes) [FHIR-46240](https://jira.hl7.org/browse/FHIR-46240) [See Changes Here](#.html)
14. **Resolved - change required:** (Clarification) Clarify the level of granular scopes server shall support [FHIR-46277](https://jira.hl7.org/browse/FHIR-46277) [See Changes Here](#.html)
15. **Resolved - change required:** (Enhancement) reference specific version of USCDI for each version of USCore [FHIR-46466](https://jira.hl7.org/browse/FHIR-46466) [See Changes Here](#.html)
16. **Resolved - change required:** (Correction) change page status [FHIR-46514](https://jira.hl7.org/browse/FHIR-46514) [See Changes Here](#.html)
17. **Resolved - change required:** (Clarification) clarify conformance requirements for structured assessments [FHIR-47139](https://jira.hl7.org/browse/FHIR-47139) [See Changes Here](#.html)
18. **Resolved - change required:** (Enhancement) Point to new THO Discharge Disposition (NUBC) instead of US Core based set [FHIR-47416](https://jira.hl7.org/browse/FHIR-47416) [See Changes Here](#.html)
19. **Resolved - change required:** (Enhancement) Tighten constraint on name.use to support better patient matching  [FHIR-48416](https://jira.hl7.org/browse/FHIR-48416) [See Changes Here](#.html)
20. **Resolved - change required:** (Clarification) RelatedPerson ""active"" is required [FHIR-48439](https://jira.hl7.org/browse/FHIR-48439) [See Changes Here](#.html)
21. **Resolved - change required:** (Clarification) Remove contradictory guidance on reference resolution in US Core [FHIR-48446](https://jira.hl7.org/browse/FHIR-48446) [See Changes Here](#.html)
...
10. **Resolved - change required:** (Enhancement) Change Binding at observation.value in Pregnancy Intention to VSAC set [FHIR-46263](https://jira.hl7.org/browse/FHIR-46263) [See Changes Here](#.html)
11. **Resolved - change required:** (Enhancement) Add SDOH Goals value set as ""Additional Binding"" in Goal Profile [FHIR-46266](https://jira.hl7.org/browse/FHIR-46266) [See Changes Here](#.html)
12. **Resolved - change required:** (Correction) Conflict requirements for SMART App Launch [FHIR-46279](https://jira.hl7.org/browse/FHIR-46279) [See Changes Here](#.html)
13. **Resolved - change required:** (Enhancement) Survey Codes Set - Refine and change binding to VSAC set [FHIR-46347](https://jira.hl7.org/browse/FHIR-46347) [See Changes Here](#.html)
14. **Resolved - change required:** (Clarification) how to handle overlapping granular scopes overlap? How can US Core better anticipate UX impact of scopes? [FHIR-46748](https://jira.hl7.org/browse/FHIR-46748) [See Changes Here](#.html)
15. **Resolved - change required:** (Enhancement) Add USCDI v5 Data Elements to US Core [FHIR-48443](https://jira.hl7.org/browse/FHIR-48443) [See Changes Here](#.html)
16. **Applied:** (Correction) Update US Core Clinical Note Type Valueset to align with Clinical Note Guidance [FHIR-48607](https://jira.hl7.org/browse/FHIR-48607) [See Changes Here](#.html)
17. **Resolved - change required:** (Correction) Change Average Blood Pressure Profile minimum from 0 to 1 [FHIR-45724](https://jira.hl7.org/browse/FHIR-45724) [See Changes Here](#.html)
18. **Resolved - change required:** (Enhancement) Deprecate every version before 3.1.1  [FHIR-46065](https://jira.hl7.org/browse/FHIR-46065) [See Changes Here](#.html)
19. **Resolved - change required:** (Enhancement) Align Encounter Type between C-CDA and FHIR US Core [FHIR-46259](https://jira.hl7.org/browse/FHIR-46259) [See Changes Here](#.html)
20. **Pre-Applied:** (Clarification) Update Must Support page when no reference targets labeled Must Support and update must support labels for Observation.performer targets [FHIR-48442](https://jira.hl7.org/browse/FHIR-48442) See Changes:
   - [Must Support - Resource References](must-support.html#must-support---resource-references)
...
21. **Triaged:** () All lab orders and results across all FHIR IGs need to indicate the performing laboratory test order name and/or performing laboratory test result name [FHIR-43301](https://jira.hl7.org/browse/FHIR-43301) [See Changes Here](#.html)
22. **Triaged:** () Create new section in Guidance on Sex and Gender in USCore [FHIR-44115](https://jira.hl7.org/browse/FHIR-44115) [See Changes Here](#.html)
23. **Resolved - change required:** (Correction) Spelling errors in US Core Server Capability Statement [FHIR-45451](https://jira.hl7.org/browse/FHIR-45451) [See Changes Here](#.html)
24. **Triaged:** (Correction) PHINVADS links broken [FHIR-45494](https://jira.hl7.org/browse/FHIR-45494) [See Changes Here](#.html)
25. **Triaged:** (Correction) Typo in Condition's granular scope [FHIR-45961](https://jira.hl7.org/browse/FHIR-45961) [See Changes Here](#.html)
26. **Resolved - change required:** (Clarification) clarify expectations for US@ for health systems [FHIR-46020](https://jira.hl7.org/browse/FHIR-46020) [See Changes Here](#.html)
27. **Triaged:** (Clarification) Clarify how "Additional USCDI" is applied for complex elements [FHIR-46028](https://jira.hl7.org/browse/FHIR-46028) [See Changes Here](#.html)
28. **Triaged:** (Correction) US Core Screening Assessment Observation Category in US Core v7 [FHIR-46052](https://jira.hl7.org/browse/FHIR-46052) [See Changes Here](#.html)
29. **Triaged:** (Enhancement) Fix the US Core History Page [FHIR-46749](https://jira.hl7.org/browse/FHIR-46749) [See Changes Here](#.html)
30. **Pre-Applied:** (Enhancement) Create SCT Specimen Condition value set to include SNOMED CT [FHIR-47061](https://jira.hl7.org/browse/FHIR-47061) See Changes Here:
