...
2. **Resolved - change required:** (Enhancement) Add link in history page to approved pages [FHIR-42950](https://jira.hl7.org/browse/FHIR-42950) See Changes [Here](https://hl7.org/fhir/us/core/history.html)
3. **Resolved - change required:** (Correction) Override built-in examples for address elements [FHIR-43054](https://jira.hl7.org/browse/FHIR-43054) See Changes [Here](StructureDefinition-us-core-patient.html)
4. **Resolved - change required:** (Enhancement) Seems like observation-category CodeSystem needs to be extended to include a concept for care-experience-preference [FHIR-43541](https://jira.hl7.org/browse/FHIR-43541) See Changes [Here]()
5. **Resolved - change required:** (Enhancement) Create new section in Guidance on Sex and Gender in USCore [FHIR-44115](https://jira.hl7.org/browse/FHIR-44115) See Changes [Here](https://hl7.org/fhir/us/core/2024Jan/general-guidance.html)
6. **Resolved - change required:** (Enhancement) Add requirements for client reference resolution [FHIR-45179](https://jira.hl7.org/browse/FHIR-45179) See Changes [Here](CapabilityStatement-us-core-client.html)
7. **Resolved - change required:** (Clarification) Derive composite search parameters for derived normal parameters [FHIR-46036](https://jira.hl7.org/browse/FHIR-46036) See Changes [Here](https://www.hl7.org/fhir/us/core/SearchParameter-us-core-observation-code.html)
8. **Resolved - change required:** (Correction) Procedure.code should be Procedure.performed [FHIR-46037](https://jira.hl7.org/browse/FHIR-46037) See Changes [Here]()
9. **Resolved - change required:** (Enhancement) Deprecate every version before 3.1.1  [FHIR-46065](https://jira.hl7.org/browse/FHIR-46065) See Changes [Here](https://hl7.org/fhir/us/core/changes.html)
10. **Resolved - change required:** (Clarification) Is the Provenance Quick Start API Correct? [FHIR-46077](https://jira.hl7.org/browse/FHIR-46077) See Changes [Here](https://hl7.org/fhir/us/core/StructureDefinition-us-core-provenance.html#mandatory-search-parameters)
11. **Resolved - change required:** (Correction) Incorrect Examples [FHIR-46099](https://jira.hl7.org/browse/FHIR-46099) See Changes [Here]()
12. **Resolved - change required:** (Enhancement) Continue to harmonize/share value sets used in US Core and C-CDA in the US Core 8.0 ballot and C-CDA 4.0 ballot [FHIR-46181](https://jira.hl7.org/browse/FHIR-46181) See Changes [Here](https://hl7.org/fhir/us/core/terminology.html)
13. **Resolved - change required:** (Correction) NAIC Code Number Identifier system not registered in THO [FHIR-46185](https://jira.hl7.org/browse/FHIR-46185) See Changes [Here](StructureDefinition-us-core-organization-definitions.html#diff_Organization.identifier:NAIC)
14. **Resolved - change required:** (Enhancement) Discharge Disposition - US Core and C-CDA need to change to point to THO set  [FHIR-46194](https://jira.hl7.org/browse/FHIR-46194) See Changes [Here](http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter)
15. **Resolved - change required:** (Enhancement) Align Encounter Type between C-CDA and FHIR US Core [FHIR-46259](https://jira.hl7.org/browse/FHIR-46259) See Changes [Here](http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter)
16. **Resolved - change required:** (Enhancement) Add SDOH Goals value set as ""Additional Binding"" in Goal Profile [FHIR-46266](https://jira.hl7.org/browse/FHIR-46266) See Changes [Here](http://hl7.org/fhir/us/core/StructureDefinition/us-core-goal)
17. **Resolved - change required:** (Clarification) Clarify the level of granular scopes server shall support [FHIR-46277](https://jira.hl7.org/browse/FHIR-46277) See Changes [Here](scopes.html#additional-us-core-requirements)
18. **Resolved - change required:** (Enhancement) reference specific version of USCDI for each version of USCore [FHIR-46466](https://jira.hl7.org/browse/FHIR-46466) See Changes [Here]()
19. **Resolved - change required:** (Correction) change page status [FHIR-46514](https://jira.hl7.org/browse/FHIR-46514) See Changes [Here]()
20. **Triaged:** () US Core detailed ethnicity expansion error [FHIR-46638](https://jira.hl7.org/browse/FHIR-46638) See Changes [Here](ValueSet-detailed-ethnicity.html)
21. **Triaged:** () Fix the US Core History Page [FHIR-46749](https://jira.hl7.org/browse/FHIR-46749) See Changes [Here](history.html)
22. **Resolved - change required:** (Enhancement) Point to new THO Discharge Disposition (NUBC) instead of US Core based set [FHIR-47416](https://jira.hl7.org/browse/FHIR-47416) See Changes [Here](ValueSet-us-core-discharge-disposition.html)
23. **Resolved - change required:** (Enhancement) Tighten constraint on name.use to support better patient matching  [FHIR-48416](https://jira.hl7.org/browse/FHIR-48416) See Changes [Here]()
24. **Resolved - change required:** (Enhancement) Update Must Support Resource References section in general and for Observation.performer targets [FHIR-48442](https://jira.hl7.org/browse/FHIR-48442) See Changes [Here](StructureDefinition-us-core-simple-observation.html)
25. **Resolved - change required:** (Enhancement) Add USCDI v5 Data Elements to US Core [FHIR-48443](https://jira.hl7.org/browse/FHIR-48443) See Changes [Here](uscdi.html)
26. **Resolved - change required:** (Clarification) Update last_updated SHOULDS to SHALLS [FHIR-48542](https://jira.hl7.org/browse/FHIR-48542) See Changes [Here](StructureDefinition-us-core-encounter.html#mandatory-and-must-support-data-elements)
27. **Triaged:** (Clarification) Exclude ICD-10-CM header codes from Condition Codes [FHIR-48742](https://jira.hl7.org/browse/FHIR-48742) See Changes [Here](ValueSet-us-core-condition-code.html#logical-definition-cld)
28. **Resolved - change required:** (Correction) Remove additional USCDI tag from Element [FHIR-48754](https://jira.hl7.org/browse/FHIR-48754) See Changes [Here](StructureDefinition-us-core-observation-screening-assessment.html)
29. **Triaged:** (Clarification) Add guidance on reference to Observation target  [FHIR-48756](https://jira.hl7.org/browse/FHIR-48756) See Changes [Here](StructureDefinition-us-core-observation-screening-assessment.html)
30. **Triaged:** (Clarification) Add conformance rule about using US Core profiles with Operations [FHIR-48822](https://jira.hl7.org/browse/FHIR-48822) See Changes [Here](general-requirements.html)
31. **Resolved - change required:** (Enhancement) Change Screening Assessment Profile category:screening-assessment to Add'l USCDI [FHIR-48849](https://jira.hl7.org/browse/FHIR-48849) See Changes [Here](StructureDefinition-us-core-observation-screening-assessment.html)
32. **Resolved - change required:** (Enhancement) Change Problems category to Add'l USCDI [FHIR-48850](https://jira.hl7.org/browse/FHIR-48850) See Changes [Here](StructureDefinition-us-core-condition-problems-health-concerns.html)
33. **Triaged:** (Clarification) Remove or Update STU Note regarding the Argonauts 2023 SMART Imaging Access project  [FHIR-48851](https://jira.hl7.org/browse/FHIR-48851) See Changes [Here](StructureDefinition-us-core-diagnosticreport-note.html)
34. **Applied:** (Correction)  Typo "PractitionerRole" instead of "PracitionRole" [FHIR-48866](https://jira.hl7.org/browse/FHIR-48866) See Changes [Here](CapabilityStatement-us-core-server.html#healthcareservice)
35. **Triaged:** () How to deal with searchparameters in the package that only convey expectations [FHIR-48876](https://jira.hl7.org/browse/FHIR-48876) See Changes [Here](https://www.hl7.org/fhir/us/core/search-parameters-and-operations.html#search-parameters)
36. **Triaged:** (Clarification) Challenging to find the codeSystem for valueSets in Terminology [FHIR-48889](https://jira.hl7.org/browse/FHIR-48889) See Changes [Here](terminology.html)
37. **Triaged:** () Example Observation: Substance Use Status Example Miscoded [FHIR-48931](https://jira.hl7.org/browse/FHIR-48931) See Changes [Here](Observation-substance-use-status.html)
38. **Resolved - change required:** (Correction) Provenance-Participant-Type Value Set does not link to terminology Code System [FHIR-49009](https://jira.hl7.org/browse/FHIR-49009) See Changes [Here](ValueSet-us-core-provenance-participant-type.html)
39. **Applied:** (Correction) Typo "content.attachment.url/data" instead of "content.url/data" [FHIR-49023](https://jira.hl7.org/browse/FHIR-49023) See Changes:
...
40. **Triaged:** (Correction) Add Provenance Author and Author Role to USCDI Table [FHIR-49024](https://jira.hl7.org/browse/FHIR-49024) See Changes [Here](uscdi.html)
41. **Triaged:** (Clarification) Clarify A MedicationRequest resource query [FHIR-49038](https://jira.hl7.org/browse/FHIR-49038) See Changes [Here](medication-list.html#fetching-all-medications-active-medications-and-all-medications-for-an-encounter)
42. **Triaged:** (Clarification) Clarify MedicationRequest Profile Specific Implementation Guidance: [FHIR-49039](https://jira.hl7.org/browse/FHIR-49039) See Changes [Here](StructureDefinition-us-core-medicationrequest.html)
43. **Triaged:** (Correction) Inconsistent individual level provenance documentation [FHIR-49064](https://jira.hl7.org/browse/FHIR-49064) See Changes [Here]()
44. **Triaged:** (Correction) Screening Assessment profile is inconsistent in wording [FHIR-49065](https://jira.hl7.org/browse/FHIR-49065) See Changes [Here]()
45. **Triaged:** (Correction) Individual Level Provenance inconsistencies [FHIR-49066](https://jira.hl7.org/browse/FHIR-49066) See Changes [Here]()
46. **Applied:** (Correction) Plural vs singular wording for provenance elements [FHIR-49067](https://jira.hl7.org/browse/FHIR-49067) See Changes [Here](StructureDefinition-us-core-immunization.html)
47. **Applied:** (Correction) Typo "service should happen" instead of "serviceSHOULDhappen" [FHIR-49068](https://jira.hl7.org/browse/FHIR-49068) See Changes [Here](StructureDefinition-us-core-servicerequest.html)
48. **Triaged:** (Clarification) Clarify ServiceRequest.code content [FHIR-49069](https://jira.hl7.org/browse/FHIR-49069) See Changes [Here]()
49. **Applied:** (Correction) typo "and" instead of "amd" [FHIR-49087](https://jira.hl7.org/browse/FHIR-49087) See Changes [Here](index.html#home)
50. **Triaged:** (Correction) bad link - gives error page [FHIR-49089](https://jira.hl7.org/browse/FHIR-49089) See Changes [Here](index.html#home)
51. **Applied:** (Correction) typo "RESTful" instead of "RESTfUl" [FHIR-49090](https://jira.hl7.org/browse/FHIR-49090) See Changes [Here](general-requirements.html#us-core-conformance-artifacts)
52. **Applied:** (Correction) Correct figure label [FHIR-49095](https://jira.hl7.org/browse/FHIR-49095) See Changes [Here](must-support.html#key-elements-table-view)
53. **Applied:** (Correction) Add missing word "support" [FHIR-49098](https://jira.hl7.org/browse/FHIR-49098) See Changes [Here](must-support.html#must-support---complex-elements)
54. **Applied:** (Correction) Add missing word "and" [FHIR-49099](https://jira.hl7.org/browse/FHIR-49099) See Changes [Here](must-support.html#must-support-targets-for-us-core-profiles)
55. **Triaged:** () Update name of resource element to proper name [FHIR-49100](https://jira.hl7.org/browse/FHIR-49100) See Changes [Here](StructureDefinition-us-core-specimen.html#mandatory-and-must-support-data-elements)
56. **Triaged:** () Unclear how Lab Order is linked to from the DiagnosticReport [FHIR-49101](https://jira.hl7.org/browse/FHIR-49101) See Changes [Here](StructureDefinition-us-core-diagnosticreport-lab.html)
57. **Triaged:** (Clarification) Reporting specimen type rules [FHIR-49102](https://jira.hl7.org/browse/FHIR-49102) See Changes [Here](StructureDefinition-us-core-specimen.html#mandatory-and-must-support-data-elements)
58. **Resolved - change required:** (Enhancement) Add NCSBN as an identifier in addition to NPI [FHIR-49122](https://jira.hl7.org/browse/FHIR-49122) See Changes [Here](StructureDefinition-us-core-practitioner.html#root)
59. **Resolved - change required:** (Enhancement) Clarify US Core's relationship with IPA [FHIR-49123](https://jira.hl7.org/browse/FHIR-49123) See Changes [Here](general-requirements.html)
60. **Triaged:** () Add asked-declined to Race and Ethnicity Value Sets [FHIR-49134](https://jira.hl7.org/browse/FHIR-49134) See Changes [Here](ValueSet-omb-race-category.html)
61. **Triaged:** () Is ""value"" a valid URI for pronouns? [FHIR-49145](https://jira.hl7.org/browse/FHIR-49145) See Changes [Here](StructureDefinition-us-core-patient-definitions.html#key_Patient.extension:personalPronouns)
62. **Triaged:** (Correction) new profiles are not listed in CapabilityStatement [FHIR-49162](https://jira.hl7.org/browse/FHIR-49162) See Changes [Here](CapabilityStatement-us-core-server.html)
63. **Triaged:** (Correction) Observation should be US Core Observation Screening Assessment Profile  [FHIR-49163](https://jira.hl7.org/browse/FHIR-49163) See Changes [Here](StructureDefinition-us-core-observation-screening-assessment.html)
64. **Applied:** (Correction) Remove Duplicate Specific Implementation Guidance: [FHIR-49164](https://jira.hl7.org/browse/FHIR-49164) See Changes [Here](StructureDefinition-us-core-simple-observation.html)
65. **Resolved - change required:** (Clarification) Language for linking to Assessment Profile is confusing [FHIR-49197](https://jira.hl7.org/browse/FHIR-49197) See Changes [Here](screening-and-assessments.html)
66. **Triaged:** () Add evidence.detail with USCDI tag to US Core Condition Problems and Health Concerns [FHIR-49198](https://jira.hl7.org/browse/FHIR-49198) See Changes [Here](StructureDefinition-us-core-condition-problems-health-concerns.html)
67. **Triaged:** () Context of Use  [FHIR-49200](https://jira.hl7.org/browse/FHIR-49200) See Changes [Here](StructureDefinition-us-core-authentication-time.html)
68. **Triaged:** () Address differences between ADI Document and Document Resource to require new profile [FHIR-49208](https://jira.hl7.org/browse/FHIR-49208) See Changes [Here](StructureDefinition-us-core-adi-documentreference-mappings.html)
69. **Triaged:** (Enhancement) Add a cross reference table in chapter 1 showing which version of USCore relates to each version of USCDI [FHIR-49219](https://jira.hl7.org/browse/FHIR-49219) See Changes [Here](index.html)
70. **Triaged:** (Enhancement) Correct Allergy & Condition provenance author assignments [FHIR-49221](https://jira.hl7.org/browse/FHIR-49221) See Changes [Here](basic-provenance.html)
71. **Triaged:** () Remove slicing from authenticationTime Extension [FHIR-49232](https://jira.hl7.org/browse/FHIR-49232) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html)
72. **Triaged:** () Align US Core and C-CDA Race and Ethnicity Value Set Concepts [FHIR-49234](https://jira.hl7.org/browse/FHIR-49234) See Changes [Here](StructureDefinition-us-core-patient.html)
73. **Triaged:** () Clarify the difference between ADI DocumentReference and other DocumentReference [FHIR-49249](https://jira.hl7.org/browse/FHIR-49249) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html)
74. **Triaged:** (Clarification) Fix ADI DocumentReference patient+category search requirement [FHIR-49250](https://jira.hl7.org/browse/FHIR-49250) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html#mandatory-search-parameters)
75. **Triaged:** () SPCU Implementation  [FHIR-49279](https://jira.hl7.org/browse/FHIR-49279) See Changes [Here](StructureDefinition-us-core-patient.html)
76. **Triaged:** () Update Observation.derivedFrom examples for Observation Screening Assessment Profile [FHIR-49289](https://jira.hl7.org/browse/FHIR-49289) See Changes [Here](StructureDefinition-us-core-observation-screening-assessment.html)
77. **Triaged:** (Correction) should use CVX code set instead of VSAC value set [FHIR-49292](https://jira.hl7.org/browse/FHIR-49292) See Changes [Here](StructureDefinition-us-core-immunization.html#profile)
78. **Applied:** (Correction) Correct CVX vaccine codes link [FHIR-49293](https://jira.hl7.org/browse/FHIR-49293) See Changes [Here](StructureDefinition-us-core-immunization.html#profile)
79. **Triaged:** (Enhancement) Define the Acronym 'ADI' in all pages where it is used [FHIR-49299](https://jira.hl7.org/browse/FHIR-49299) See Changes [Here]()
80. **Applied:** (Correction) Fix typo "HSLOC" instead of "HLSOC" [FHIR-49301](https://jira.hl7.org/browse/FHIR-49301) See Changes [Here](ValueSet-us-core-location-type.html)
81. **Triaged:** (Clarification) it would be helpful to have a short statement narrative of this historical information within the new profile. [FHIR-49305](https://jira.hl7.org/browse/FHIR-49305) See Changes [Here](index.html)
82. **Resolved - change required:** (Correction) Corrections to typos [FHIR-49306](https://jira.hl7.org/browse/FHIR-49306) See Changes [Here]()
83. **Resolved - change required:** (Correction) Fix typo 'Advance Directives' instead 'Advanced Directives' [FHIR-49307](https://jira.hl7.org/browse/FHIR-49307) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html)
84. **Triaged:** () Make CodeableConcept.text must support when used in observation.code [FHIR-49308](https://jira.hl7.org/browse/FHIR-49308) See Changes [Here](StructureDefinition-us-core-observation-lab-definitions.html#Observation.code)
85. **Triaged:** (Enhancement) US Core CarePlan should not require category of 'assess-plan' [FHIR-49309](https://jira.hl7.org/browse/FHIR-49309) See Changes [Here]()
86. **Triaged:** (Clarification) Coverage.type binding contains multiple concepts [FHIR-49310](https://jira.hl7.org/browse/FHIR-49310) See Changes [Here]()
87. **Triaged:** () Change requirement that Procedure.basedOn CarePlan can only be US Core CarePlan [FHIR-49311](https://jira.hl7.org/browse/FHIR-49311) See Changes [Here]()
88. **Triaged:** () Hyperlink discrepancy [FHIR-49335](https://jira.hl7.org/browse/FHIR-49335) See Changes [Here](StructureDefinition-us-core-diagnosticreport-lab.html#terminology-bindings-differential)
89. **Triaged:** () Hyperlink discrepancy [FHIR-49336](https://jira.hl7.org/browse/FHIR-49336) See Changes [Here](StructureDefinition-us-core-diagnosticreport-lab.html#terminology-bindings-differential)
90. **Triaged:** () Hyperlink discrepancy [FHIR-49337](https://jira.hl7.org/browse/FHIR-49337) See Changes [Here](StructureDefinition-us-core-observation-lab.html#terminology-bindings-differential)
91. **Resolved - change required:** (Clarification) Cardinality does not match element definition [FHIR-49338](https://jira.hl7.org/browse/FHIR-49338) See Changes [Here](StructureDefinition-us-core-diagnosticreport-lab.html#profile)
92. **Triaged:** () clarify interpretation of sex [FHIR-49353](https://jira.hl7.org/browse/FHIR-49353) See Changes [Here](StructureDefinition-us-core-patient-definitions.html#Patient.extension:sex)
93. **Triaged:** () Fix ""Sex"" value set in VSAC [FHIR-49366](https://jira.hl7.org/browse/FHIR-49366) See Changes [Here](StructureDefinition-us-core-sex.html)
94. **Triaged:** (Enhancement) Please add a ""Plain Language Summary about this Guide"" to the home page [FHIR-49367](https://jira.hl7.org/browse/FHIR-49367) See Changes [Here](index.html)
95. **Resolved - change required:** (Correction) Typo in US Core Yearly Updates diagram [FHIR-49376](https://jira.hl7.org/browse/FHIR-49376) See Changes [Here](future-of-US-core.html)
96. **Triaged:** () Preferred Language Recommendation to use Language Proficiency Extension is incorrect [FHIR-49391](https://jira.hl7.org/browse/FHIR-49391) See Changes [Here](StructureDefinition-us-core-encounter.html)
97. **Triaged:** () Clarify reference to race and ethnicity category codes  [FHIR-49392](https://jira.hl7.org/browse/FHIR-49392) See Changes [Here](StructureDefinition-us-core-patient.html)
98. **Triaged:** (Clarification) Clarify reference to CDCREC [FHIR-49393](https://jira.hl7.org/browse/FHIR-49393) See Changes [Here](StructureDefinition-us-core-patient.html)
99. **Triaged:** (Correction) SOPT Value Set - change CLD to Extensional [FHIR-49395](https://jira.hl7.org/browse/FHIR-49395) See Changes [Here](StructureDefinition-us-core-coverage.html)
100. **Triaged:** () US Realm Gender Identity Value Set Changes  [FHIR-49396](https://jira.hl7.org/browse/FHIR-49396) See Changes [Here](https://www.hl7.org/fhir/us/core/StructureDefinition-us-core-patient.html)
101. **Triaged:** (Enhancement) Patient Communication Language - change binding to THO once in place [FHIR-49397](https://jira.hl7.org/browse/FHIR-49397) See Changes [Here](https://www.hl7.org/fhir/us/core/StructureDefinition-us-core-patient.html)
102. **Triaged:** (Correction) References to ONC should be changed to ASTP where appropriate [FHIR-49399](https://jira.hl7.org/browse/FHIR-49399) See Changes [Here](https://www.hl7.org/fhir/us/core/index.html#background)
103. **Triaged:** (Correction) Authentication-time extension maturity level should not be 3 [FHIR-49400](https://jira.hl7.org/browse/FHIR-49400) See Changes [Here](StructureDefinition-us-core-authentication-time.html)
104. **Triaged:** () US Core Location Type Value Set missing HSLOC Guidance [FHIR-49401](https://jira.hl7.org/browse/FHIR-49401) See Changes [Here](ValueSet-us-core-location-type.html)
105. **Triaged:** (Clarification) Spell out/define SOP in diagnostic report imaging study context  [FHIR-49402](https://jira.hl7.org/browse/FHIR-49402) See Changes [Here](StructureDefinition-us-core-diagnosticreport-note.html)
106. **Triaged:** (Correction) Medication Route of Admin terminology binding is missing NCI concepts [FHIR-49403](https://jira.hl7.org/browse/FHIR-49403) See Changes [Here](StructureDefinition-us-core-medicationrequest.html)
107. **Applied:** (Correction) Change number of common clinical notes to 10 [FHIR-49413](https://jira.hl7.org/browse/FHIR-49413) See Changes [Here](StructureDefinition-us-core-documentreference.html#mandatory-and-must-support-data-elements)
108. **Applied:** (Correction) Correction to Observation ADI Documentation Profile Introduction [FHIR-49414](https://jira.hl7.org/browse/FHIR-49414) See Changes [Here](StructureDefinition-us-core-observation-adi-documentation.html)
109. **Triaged:** (Clarification) Clarify guidance for .value element of Observation ADI Documentation Profile [FHIR-49415](https://jira.hl7.org/browse/FHIR-49415) See Changes [Here](StructureDefinition-us-core-observation-adi-documentation.html#mandatory-and-must-support-data-elements)
110. **Resolved - change required:** (Enhancement) Update link for ""Advance Healthcare Directive Categories Grouper"" value set [FHIR-49419](https://jira.hl7.org/browse/FHIR-49419) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html#mandatory-and-must-support-data-elements)
111. **Triaged:** () Consider privacy implications of guidance for external content referenced by ADI documentReference [FHIR-49424](https://jira.hl7.org/browse/FHIR-49424) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html#mandatory-and-must-support-data-elements)
112. **Resolved - change required:** (Correction) Fix link in USCDI table - sex parameter for clinical use element [FHIR-49426](https://jira.hl7.org/browse/FHIR-49426) See Changes [Here](uscdi.html#uscdi)
113. **Applied:** (Correction) Remove duplicate listing and add US Core RelatedPerson Profile to listing to USCDI table [FHIR-49432](https://jira.hl7.org/browse/FHIR-49432) See Changes [Here](uscdi.html#uscdi)
114. **Resolved - change required:** (Correction) Fix link in USCDI table - pronouns element [FHIR-49434](https://jira.hl7.org/browse/FHIR-49434) See Changes [Here](uscdi.html#uscdi)
115. **Triaged:** () Consider including guidance about pronouns in the ""profile specific implementation guidance"" section [FHIR-49435](https://jira.hl7.org/browse/FHIR-49435) See Changes [Here](StructureDefinition-us-core-patient.html#mandatory-and-must-support-data-elements)
116. **Triaged:** () Fixed codes in observation profiles are not included in the bound value set [FHIR-49444](https://jira.hl7.org/browse/FHIR-49444) See Changes [Here](StructureDefinition-us-core-observation-adi-documentation.html#profile)
117. **Resolved - change required:** (Enhancement) Add general guidance about using CQL with US Core [FHIR-49477](https://jira.hl7.org/browse/FHIR-49477) See Changes [Here](general-guidance.html)
118. **Triaged:** () Laboratory Orders need Test Name (code is insufficient) for CLIA and accreditationCompliance [FHIR-49609](https://jira.hl7.org/browse/FHIR-49609) See Changes [Here](StructureDefinition-us-core-servicerequest.html)
119. **Triaged:** (Correction) correct line 81 in terminology  [FHIR-49610](https://jira.hl7.org/browse/FHIR-49610) See Changes [Here](terminology.html)
120. **Triaged:** () Align category slices with other work on category slices for clinical-documents as distinct from clinical-notes [FHIR-49612](https://jira.hl7.org/browse/FHIR-49612) See Changes [Here]()
121. **Triaged:** () Value Set Problems for US Core ADI DocumentReference [FHIR-49615](https://jira.hl7.org/browse/FHIR-49615) See Changes [Here]()
122. **Triaged:** (Correction) Clean up examples for FHIR ADI DocumentReference Profile [FHIR-49617](https://jira.hl7.org/browse/FHIR-49617) See Changes [Here]()
123. **Triaged:** () Laboratory Test Report (FHIR Observations and Diagnostic Report) Issues [FHIR-49623](https://jira.hl7.org/browse/FHIR-49623) See Changes [Here](StructureDefinition-us-core-diagnosticreport-lab.html)
124. **Triaged:** () Needs fine-grained access control [FHIR-49624](https://jira.hl7.org/browse/FHIR-49624) See Changes [Here]()
125. **Triaged:** () US Core FHIR Lab Observation Updates needed [FHIR-49630](https://jira.hl7.org/browse/FHIR-49630) See Changes [Here](StructureDefinition-us-core-observation-lab.html)
126. **Triaged:** (Correction) Expansion of ValueSet us-core-laboratory-test-codes yields no concepts [FHIR-49642](https://jira.hl7.org/browse/FHIR-49642) See Changes [Here](ValueSet-us-core-laboratory-test-codes.html)
127. **Triaged:** () Update Image and typo on Figure 2: US Core DocumentReference.category [FHIR-49702](https://jira.hl7.org/browse/FHIR-49702) See Changes [Here](general-requirements.html)
128. **Submitted:** () Reconsider the Value Set binding for Practitioner.qualification.code [FHIR-49812](https://jira.hl7.org/browse/FHIR-49812) See Changes [Here]()
129. **Triaged:** () Fix this Value Set Definition [FHIR-49877](https://jira.hl7.org/browse/FHIR-49877) See Changes [Here]()
130. **Triaged:** () PractitionerRole.specialty is misaligned with DocumentReference.practiceSetting [FHIR-49880](https://jira.hl7.org/browse/FHIR-49880) See Changes [Here]()
