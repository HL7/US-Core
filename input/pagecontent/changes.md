...
34. **Resolved - change required:**  (Correction) Typos in table Cross Version Comparisons [FHIR-54387](https://jira.hl7.org/browse/FHIR-54387) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/changes-between-versions.html#cross-version-comparisons)
...
58. **Triaged:**  () Align valueSet for RelatedPerson.relationship with Personal and Legal Relationship Relationship RoleType [FHIR-53376](https://jira.hl7.org/browse/FHIR-53376) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-relatedperson-definitions.html#RelatedPerson.relationship)
