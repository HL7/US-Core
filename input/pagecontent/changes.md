...
22. **Resolved - change required:** Need reason for personal characteristic Obs.effectiveDateTime invariant [FHIR-36932](https://jira.hl7.org/browse/FHIR-36932) [See Changes Here](#)
...
24. **Applied** change 'resources' to 'profiles' [FHIR-37343](https://jira.hl7.org/browse/FHIR-37343) [See Changes Here](StructureDefinition-us-core-provenance.html#mandatory-and-must-support-data-elements)
...
32. **Submitted:** Remove extra instance or the word ""resource"" in Lab observation narrative profile [FHIR-37507](https://jira.hl7.org/browse/FHIR-37507) [See Changes Here](#)
33. **Resolved - change required:** Gender Identity in US Core Patient should allow multiple and the extension should be updated to contain date ranges. [FHIR-37509](https://jira.hl7.org/browse/FHIR-37509) [See Changes Here](#)
34. **Triaged:** Update US Core Encounter to use profiled resources for Encounter.diagnosis.condition [FHIR-37511](https://jira.hl7.org/browse/FHIR-37511) [See Changes Here](#)
35. **Applied:** Typos on Patient and Practitioner ""Name"" SearchParameter pages [FHIR-37541](https://jira.hl7.org/browse/FHIR-37541) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/SearchParameter-us-core-patient-name.html) and [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/SearchParameter-us-core-practitioner-name.html)
36. **Resolved - change required:** Add Mapping and guidance on DocumentReference.category to IHE XDS [FHIR-37592](https://jira.hl7.org/browse/FHIR-37592) [See Changes Here](#)
37. **Submitted:** Patient's name search parameter lists suffix twice [FHIR-37687](https://jira.hl7.org/browse/FHIR-37687) [See Changes Here](#)
38. **Applied:** Correct us-core-6 invariant expression [FHIR-37704](https://jira.hl7.org/browse/FHIR-37704) [See Changes Here](StructureDefinition-us-core-patient.profile.xml.html)
39. **Triaged:** Immunization.primarySource requirement change and/or text edit [FHIR-37723](https://jira.hl7.org/browse/FHIR-37723) [See Changes Here](#)
40. **Applied:** Added supportedProfiles to US Core CapabilityStatements[FHIR-37766](https://jira.hl7.org/browse/FHIR-37766) [See Changes Here](CapabilityStatement-us-core-server.html#encounter)
41. **Triaged:** US Core Diagnostic Report Category element is not usable as is [FHIR-37770](https://jira.hl7.org/browse/FHIR-37770) [See Changes Here](#)
42. **Resolved - change required:** Does US Core 5 require SMARTv2 ? [FHIR-37813](https://jira.hl7.org/browse/FHIR-37813) [See Changes Here](#)
43. **Applied:** Typo of ""DiagnostisReport"" in Clinical Notes Guidance [FHIR-37819](https://jira.hl7.org/browse/FHIR-37819) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/clinical-notes.html)
44. **Resolved - change required:** $docref should accept multiple coding parameters instead of CodeableConcept for type parameter [FHIR-37894](https://jira.hl7.org/browse/FHIR-37894) [See Changes Here](#)
45. **Resolved - change required:** Add Conformance expectation of  SHOULD to resolve for server Capability [FHIR-37901](https://jira.hl7.org/browse/FHIR-37901) [See Changes Here](#)
46. **Triaged:** Change Condition patient + category search to SHALL support [FHIR-37918](https://jira.hl7.org/browse/FHIR-37918) [See Changes Here](#)
47. **Applied:** Typo in Observation SDOH profile [FHIR-37928](https://jira.hl7.org/browse/FHIR-37928) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-observation-screening-assessments.html)
48. **Applied:** Typo in Condition Problems and Health Concerns search example [FHIR-37929](https://jira.hl7.org/browse/FHIR-37929) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-condition-problems-health-concerns.html)
49. **Triaged:** Diagnostic Report Laboratory Codes LOINC CLASSTYPE value should be ""1"" [FHIR-37933](https://jira.hl7.org/browse/FHIR-37933) [See Changes Here](#)
50. **RESOLVED - CHANGE REQUIRED:** Clarify that guide uses US Edition of SNOMED and update link to it [FHIR-38190](https://jira.hl7.org/browse/FHIR-38190) [See Changes Here](#)
51. **Resolved - change required:** update QuickStart to include all the search requirements by type. [FHIR-38629](https://jira.hl7.org/browse/FHIR-38629) [See Changes Here](#)
52. **Triaged:** specify $docref's OperationDefinition.resource to be DocumentReference [FHIR-38658](https://jira.hl7.org/browse/FHIR-38658) [See Changes Here](#)
53. **Triaged:** Remove comment in $docref [FHIR-38686](https://jira.hl7.org/browse/FHIR-38686) [See Changes Here](#)
54. **Triaged:** make DocRef.custodian optional in v3 as it is in v4 and v5 [FHIR-38700](https://jira.hl7.org/browse/FHIR-38700) [See Changes Here](#)
55. **Resolved - change required:** Add USCDI V3 Requirements [FHIR-38702](https://jira.hl7.org/browse/FHIR-38702) [See Changes Here](#)
56. **Applied:** Correct documentation on Procedure.performed attribute [FHIR-38737](https://jira.hl7.org/browse/FHIR-38737) [See Changes Here](StructureDefinition-us-core-procedure.html#mandatory-and-must-support-data-elements)
57. **Triaged:** Recommend against using LOINC procedure codes [FHIR-38739](https://jira.hl7.org/browse/FHIR-38739) [See Changes Here](#)
58. **Triaged:** Consider improving description of docref for clarity [FHIR-38746](https://jira.hl7.org/browse/FHIR-38746) [See Changes Here](#)
59. **Applied:** Fix title for US Core Pediatric Head Occipital Frontal Circumference Observation Profile [FHIR-38794](https://jira.hl7.org/browse/FHIR-38794) [See Changes Here](StructureDefinition-head-occipital-frontal-circumference-percentile.html)
60. **Triaged:** Add Refill and Quantity to MedRequest [FHIR-39343](https://jira.hl7.org/browse/FHIR-39343) [See Changes Here](#)
