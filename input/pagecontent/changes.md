...
5. **Applied:** Non-substantive (Correction) Add missing target information to individual provenance table [FHIR-52997](https://jira.hl7.org/browse/FHIR-52997) See Changes [Here](basic-provenance.html#author-and-author-role-data-elements)
6. **Applied:** Non-substantive (Correction) Correct the definition of the additional USCDI ServiceRequest element [FHIR-53029](https://jira.hl7.org/browse/FHIR-53029) See Changes [Here](StructureDefinition-us-core-servicerequest.html)
