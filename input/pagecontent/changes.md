...
81. **Triaged:** () Make CodeableConcept.text must support when used in observation.code [FHIR-49308](https://jira.hl7.org/browse/FHIR-49308) See Changes [Here](StructureDefinition-us-core-observation-lab-definitions.html#Observation.code)
