...
41. **Applied:** Added supportedProfiles to US Core CapabilityStatements[FHIR-37766](https://jira.hl7.org/browse/FHIR-37766) [See Changes Here](CapabilityStatement-us-core-server.html#encounter)
...
50. **Triaged:** Diagnostic Report Laboratory Codes LOINC CLASSTYPE value should be ""1"" [FHIR-37933](https://jira.hl7.org/browse/FHIR-37933) [See Changes Here](#)
51. **RESOLVED - CHANGE REQUIRED:** Clarify that guide uses US Edition of SNOMED and update link to it [FHIR-38190](https://jira.hl7.org/browse/FHIR-38190) [See Changes Here](#)
