...
12. **Resolved - change required:** Clinical Judgement Profile does not exist [FHIR-39650](https://jira.hl7.org/browse/FHIR-39650) [See Changes Here](#.html)
...
21. **Resolved - change required:** Must Support and Modifier Elements [FHIR-39707](https://jira.hl7.org/browse/FHIR-39707) [See Changes Here](#.html)
...
23. **Resolved - change required:** Use of mandatory text [FHIR-39709](https://jira.hl7.org/browse/FHIR-39709) [See Changes Here](#.html)
...
29. **Resolved - change required:** SHALL support clinical notes is unclear [FHIR-39716](https://jira.hl7.org/browse/FHIR-39716) [See Changes Here](#.html)
30. **Resolved - change required:** What is a Clinical Note Server? [FHIR-39717](https://jira.hl7.org/browse/FHIR-39717) [See Changes Here](#.html)
...
32. **Resolved - change required:** Determining Server Note type use of $expand [FHIR-39719](https://jira.hl7.org/browse/FHIR-39719) [See Changes Here](#.html)
...
34. **Triaged:** The use of Observations where QuestionnaireReponse is more applicable [FHIR-39722](https://jira.hl7.org/browse/FHIR-39722) [See Changes Here](#.html)
...
40. **Resolved - change required:** Screening and Assessment typo [FHIR-39735](https://jira.hl7.org/browse/FHIR-39735) [See Changes Here](#.html)
41. **Resolved - change required:** Missing Hyperlinks [FHIR-39736](https://jira.hl7.org/browse/FHIR-39736) [See Changes Here](#.html)
...
62. **Resolved - change required:** Change the title and/or description of the Simple Observation Profile [FHIR-39940](https://jira.hl7.org/browse/FHIR-39940) [See Changes Here](#.html)
...
64. **Resolved - change required:** Provide further guidance on use of US Core vs other domain specific IGs [FHIR-39943](https://jira.hl7.org/browse/FHIR-39943) [See Changes Here](#.html)
...
66. **Resolved - change required:** Change the Screening and Assessment Activities section to better reflect scope [FHIR-39945](https://jira.hl7.org/browse/FHIR-39945) [See Changes Here](#.html)
...
68. **Resolved - change required:** Update “3.6.2 Screening and Assessments” title and content [FHIR-39947](https://jira.hl7.org/browse/FHIR-39947) [See Changes Here](#.html)
69. **Resolved - change required:** Correct title of section 3.6.2.1 US Core Observation Screening an Assessments Profile [FHIR-39948](https://jira.hl7.org/browse/FHIR-39948) [See Changes Here](#.html)
70. **Resolved - change required:** Update description of Screening Assessments Profile section 3.6.2.1 [FHIR-39949](https://jira.hl7.org/browse/FHIR-39949) [See Changes Here](#.html)
71. **Resolved - change required:** The “Relationship Between Screening and Assessment Observations” header is confusing and content incorrect [FHIR-39950](https://jira.hl7.org/browse/FHIR-39950) [See Changes Here](#.html)
...
78. **Resolved - change required:** Remove MS from Observation Screening Assessment Observation.performer Practitioner Reference [FHIR-39964](https://jira.hl7.org/browse/FHIR-39964) [See Changes Here](#.html)
79. **Triaged:** Consider changing Observation.derivedFrom and hasMember QuestionnaireResponse reference to SDC QuestionnaireResponse [FHIR-39965](https://jira.hl7.org/browse/FHIR-39965) [See Changes Here](#.html)
80. **Resolved - change required:** Correct link issue in “Profile specific implementation guidance section” of the ServiceRequest Profile [FHIR-39966](https://jira.hl7.org/browse/FHIR-39966) [See Changes Here](#.html)
81. **Resolved - change required:** Coverage.type binding needs different value set or clarification on allowed codes [FHIR-39982](https://jira.hl7.org/browse/FHIR-39982) [See Changes Here](#.html)
...
83. **Resolved - change required:** Extra ) in Screening and Assessments [FHIR-40041](https://jira.hl7.org/browse/FHIR-40041) [See Changes Here](#.html)
...
98. **Resolved - change required:** Remove MustSupport from DocumentReference.category requiring clinical-note [FHIR-40102](https://jira.hl7.org/browse/FHIR-40102) [See Changes Here](#.html)
...
116. **Resolved - change required:** Specimen resource query expectations [FHIR-40180](https://jira.hl7.org/browse/FHIR-40180) [See Changes Here](#.html)
117. **Resolved - change required:** Both Occupation and Industry need to be able to accommodate text if no value is appropriate [FHIR-40181](https://jira.hl7.org/browse/FHIR-40181) [See Changes Here](#.html)
