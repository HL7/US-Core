...
1. **Resolved - change required:** Define and use the terms like Screening and Assessment consistently [FHIR-39938](https://jira.hl7.org/browse/FHIR-39938) [See Changes Here](#.html)
1. **Resolved - change required:** Change the title and/or description of the Simple Observation Profile [FHIR-39940](https://jira.hl7.org/browse/FHIR-39940) [See Changes Here](#.html)
1. **Resolved - change required:** Correct the description of the Simple Observation Profile [FHIR-39942](https://jira.hl7.org/browse/FHIR-39942) [See Changes Here](#.html)
1. **Resolved - change required:** Provide further guidance on use of US Core vs other domain specific IGs [FHIR-39943](https://jira.hl7.org/browse/FHIR-39943) [See Changes Here](#.html)
1. **Resolved - change required:** Change the framing of Screening and Assessments section [FHIR-39944](https://jira.hl7.org/browse/FHIR-39944) [See Changes Here](#.html)
1. **Resolved - change required:** Change the Screening and Assessment Activities section to better reflect scope [FHIR-39945](https://jira.hl7.org/browse/FHIR-39945) [See Changes Here](#.html)
1. **Resolved - change required:** Update the “Screening and Assessment Activities” diagram with proper profile name [FHIR-39946](https://jira.hl7.org/browse/FHIR-39946) [See Changes Here](#.html)
1. **Resolved - change required:** Update “3.6.2 Screening and Assessments” title and content [FHIR-39947](https://jira.hl7.org/browse/FHIR-39947) [See Changes Here](#.html)
1. **Resolved - change required:** Correct title of section 3.6.2.1 US Core Observation Screening an Assessments Profile [FHIR-39948](https://jira.hl7.org/browse/FHIR-39948) [See Changes Here](#.html)
1. **Resolved - change required:** Update description of Screening Assessments Profile section 3.6.2.1 [FHIR-39949](https://jira.hl7.org/browse/FHIR-39949) [See Changes Here](#.html)
1. **Resolved - change required:** The “Relationship Between Screening and Assessment Observations” header is confusing and content incorrect [FHIR-39950](https://jira.hl7.org/browse/FHIR-39950) [See Changes Here](#.html)
1. **Resolved - change required:** Correct title of section 3.6.2.2 US Core Observation Simple Observation Profile [FHIR-39951](https://jira.hl7.org/browse/FHIR-39951) [See Changes Here](#.html)
1. **Triaged:** Modify the descriptive reason why QuestonnaireResponse is not included in the IG [FHIR-39952](https://jira.hl7.org/browse/FHIR-39952) [See Changes Here](#.html)
1. **Resolved - change required:** Require US Core Server to support the Simple Observation profile for simple assessments [FHIR-39953](https://jira.hl7.org/browse/FHIR-39953) [See Changes Here](#.html)
1. **Resolved - change required:** Correct the link and sentence for assessment category codes [FHIR-39954](https://jira.hl7.org/browse/FHIR-39954) [See Changes Here](#.html)
1. **Resolved - change required:** Describe the purpose and intent of “Grouping” and update the diagram [FHIR-39955](https://jira.hl7.org/browse/FHIR-39955) [See Changes Here](#.html)
1. **Resolved - change required:** Remove US Core Common SDOH Assessments ValueSet [FHIR-39956](https://jira.hl7.org/browse/FHIR-39956) [See Changes Here](#.html)
1. **Resolved - change required:** Fix link text [FHIR-39958](https://jira.hl7.org/browse/FHIR-39958) [See Changes Here](#.html)
1. **Resolved - change required:** Remove MS from Observation Screening Assessment Observation.performer Practitioner Reference [FHIR-39964](https://jira.hl7.org/browse/FHIR-39964) [See Changes Here](#.html)
...
1. **Resolved - change required:** RelatedPerson profile text contains Observation content [FHIR-40048](https://jira.hl7.org/browse/FHIR-40048) [See Changes Here](#.html)
1. **Resolved - change required:** 2 typos in history page [FHIR-40069](https://jira.hl7.org/browse/FHIR-40069) [See Changes Here](#.html)
1. **Resolved - change required:** Reword a Quick Start example [FHIR-40072](https://jira.hl7.org/browse/FHIR-40072) [See Changes Here](#.html)
1. **Resolved - change required:** consider alternative answer choices for pregnancy intect codes [FHIR-40084](https://jira.hl7.org/browse/FHIR-40084) [See Changes Here](#.html)
1. **Resolved - change required:** Improve Screening Assessment Observation.hasMember short description [FHIR-40085](https://jira.hl7.org/browse/FHIR-40085) [See Changes Here](#.html)
1. **Resolved - change required:** Update the “bindings when slicing by value sets” figure  [FHIR-40086](https://jira.hl7.org/browse/FHIR-40086) [See Changes Here](#.html)
1. **Resolved - change required:** Consider managing resource “domain” category slices with a common pattern [FHIR-40087](https://jira.hl7.org/browse/FHIR-40087) [See Changes Here](#.html)
1. **Resolved - change required:** Add guidance to the Procedure profile to express sdoh category [FHIR-40088](https://jira.hl7.org/browse/FHIR-40088) [See Changes Here](#.html)
1. **Resolved - change required:** Improve language as to the expectations of clinicalStatus when category is problem list [FHIR-40089](https://jira.hl7.org/browse/FHIR-40089) [See Changes Here](#.html)
1. **Resolved - change required:** Alignment with FHIR DS4P IG needed - Use of Masked from the HL7 V3-ActCode is supported for data hidden due to security or privacy reason [FHIR-40090](https://jira.hl7.org/browse/FHIR-40090) [See Changes Here](#.html)
1. **Resolved - change required:** Change AHC HRSN screening tool examples from the supplemental questions to the core questions [FHIR-40091](https://jira.hl7.org/browse/FHIR-40091) [See Changes Here](#.html)
1. **Resolved - change required:** Handle “personal characteristics” as Observations versus elements on Patient [FHIR-40092](https://jira.hl7.org/browse/FHIR-40092) [See Changes Here](#.html)
1. **Resolved - change required:** Remove MustSupport from DocumentReference.category requiring clinical-note [FHIR-40102](https://jira.hl7.org/browse/FHIR-40102) [See Changes Here](#.html)
1. **Triaged:** Remove Must Support from Goal.target and Goal.target.due[x] [FHIR-40103](https://jira.hl7.org/browse/FHIR-40103) [See Changes Here](#.html)
1. **Resolved - change required:** Add patient-preference to Simple Observation Categories [FHIR-40104](https://jira.hl7.org/browse/FHIR-40104) [See Changes Here](#.html)
1. **Resolved - change required:** Add to the code systems chart  [FHIR-40124](https://jira.hl7.org/browse/FHIR-40124) [See Changes Here](#.html)
1. **Resolved - change required:** Make Specimen.subject must support [FHIR-40136](https://jira.hl7.org/browse/FHIR-40136) [See Changes Here](#.html)
1. **Resolved - change required:** Clarify use of unknown for occupation. [FHIR-40137](https://jira.hl7.org/browse/FHIR-40137) [See Changes Here](#.html)
1. **Resolved - change required:** Clarify applicability of DiagnosticReport in USCDI Mapping [FHIR-40138](https://jira.hl7.org/browse/FHIR-40138) [See Changes Here](#.html)
1. **Resolved - change required:** Remove the word ""status"" from introductory text [FHIR-40149](https://jira.hl7.org/browse/FHIR-40149) [See Changes Here](#.html)
1. **Resolved - change required:** Incorrect link for ""record or update"" and additional examples [FHIR-40151](https://jira.hl7.org/browse/FHIR-40151) [See Changes Here](#.html)
1. **Resolved - change required:** Incorrect Resource noted in the introductory paragraph [FHIR-40155](https://jira.hl7.org/browse/FHIR-40155) [See Changes Here](#.html)
1. **Resolved - change required:** Clarify what a Job is [FHIR-40158](https://jira.hl7.org/browse/FHIR-40158) [See Changes Here](#.html)
1. **Resolved - change required:** Member or subscriber id is must have but the element cardinality is 0..* [FHIR-40160](https://jira.hl7.org/browse/FHIR-40160) [See Changes Here](#.html)
1. **Resolved - change required:** Modify comment regarding Screening and Assessments [FHIR-40161](https://jira.hl7.org/browse/FHIR-40161) [See Changes Here](#.html)
1. **Resolved - change required:** 5.	Modify Examples/ValueSet for Language Codes [FHIR-40165](https://jira.hl7.org/browse/FHIR-40165) [See Changes Here](#.html)
1. **Resolved - change required:** Add Observation.focus to accommodate information about a related person [FHIR-40166](https://jira.hl7.org/browse/FHIR-40166) [See Changes Here](#.html)
1. **Resolved - change required:** Add Observation.performer to Occupation Profile [FHIR-40170](https://jira.hl7.org/browse/FHIR-40170) [See Changes Here](#.html)
1. **Resolved - change required:** Add Boolean indicator of IsCurrentJob [FHIR-40172](https://jira.hl7.org/browse/FHIR-40172) [See Changes Here](#.html)
1. **Resolved - change required:** Should Past or Present Occupation Observation.code.coding be 1..1 instead of 1..*? [FHIR-40178](https://jira.hl7.org/browse/FHIR-40178) [See Changes Here](#.html)
1. **Resolved - change required:** Specimen resource query expectations [FHIR-40180](https://jira.hl7.org/browse/FHIR-40180) [See Changes Here](#.html)
1. **Resolved - change required:** Both Occupation and Industry need to be able to accommodate text if no value is appropriate [FHIR-40181](https://jira.hl7.org/browse/FHIR-40181) [See Changes Here](#.html)
1. **Resolved - change required:** Remove duplicate of Notes: Quick Start intro bullets [FHIR-40182](https://jira.hl7.org/browse/FHIR-40182) [See Changes Here](#.html)
1. **Resolved - change required:** Need to be able to search based on combination of occupation, Industry, plus other info [FHIR-40183](https://jira.hl7.org/browse/FHIR-40183) [See Changes Here](#.html)
1. **Resolved - change required:** Change main observation to Past or Present Job  [FHIR-40187](https://jira.hl7.org/browse/FHIR-40187) [See Changes Here](#.html)
1. **Resolved - change required:** Please give guidance on US Core  on which SMART v2 scopes  [FHIR-40192](https://jira.hl7.org/browse/FHIR-40192) [See Changes Here](#.html)
1. **Resolved - change required:** US Core SFCU Extension not aligned with R5 SFCU Extension  [FHIR-40197](https://jira.hl7.org/browse/FHIR-40197) [See Changes Here](#.html)
1. **Resolved - change required:** Please correct need for the indication element on MedicationRequest [FHIR-40199](https://jira.hl7.org/browse/FHIR-40199) [See Changes Here](#.html)
1. **Resolved - change required:** ServiceRequest.reasonCode and reasonReference should be MS explicitly or text should be added explaining [FHIR-40200](https://jira.hl7.org/browse/FHIR-40200) [See Changes Here](#.html)
1. **Resolved - change required:** ServiceRequest Profile Implementation Specific Guidance - incorrect reference to ServiceRequest.reasonCode [FHIR-40202](https://jira.hl7.org/browse/FHIR-40202) [See Changes Here](#.html)
1. **Resolved - change required:** Tribal Affiliation Extension - enrollment and alignment with eCR [FHIR-40203](https://jira.hl7.org/browse/FHIR-40203) [See Changes Here](#.html)
1. **Resolved - change required:** Observation Occupation binding strength for industry is required  [FHIR-40204](https://jira.hl7.org/browse/FHIR-40204) [See Changes Here](#.html)
1. **Resolved - change required:** whenHandedOver cardinality 1..1 is not conducive for some of the statuses [FHIR-40205](https://jira.hl7.org/browse/FHIR-40205) [See Changes Here](#.html)
1. **Resolved - change required:** MedicationRequest.reasonCodeableConcept does not exist [FHIR-40235](https://jira.hl7.org/browse/FHIR-40235) [See Changes Here](#.html)
1. **Resolved - change required:** Utilize ""use"" field for patient previous name and previous address (round 2) [FHIR-40299](https://jira.hl7.org/browse/FHIR-40299) [See Changes Here](#.html)
1. **Triaged:** Patch Request: Patient.us-core-ethnicity does not allow for nullFlavors in value set [FHIR-40309](https://jira.hl7.org/browse/FHIR-40309) [See Changes Here](#.html)
1. **Resolved - change required:** remove or explain one of two NUCC bindings [FHIR-40372](https://jira.hl7.org/browse/FHIR-40372) [See Changes Here](#.html)
1. **Resolved - change required:** Must Support of Patient as Care Team Member [FHIR-40415](https://jira.hl7.org/browse/FHIR-40415) [See Changes Here](#.html)
1. **Resolved - change required:** Incorrect/nonsensical lab result/observation in CMP panel  [FHIR-40427](https://jira.hl7.org/browse/FHIR-40427) [See Changes Here](#.html)
1. **Resolved - change required:** Update to Glucose and CMP example to match CMS panel/specimen info [FHIR-40428](https://jira.hl7.org/browse/FHIR-40428) [See Changes Here](#.html)
1. **Resolved - change required:** Add Specimen upon which BUN result obtained [FHIR-40429](https://jira.hl7.org/browse/FHIR-40429) [See Changes Here](#.html)
1. **Triaged:** US core should have specific profiles for imaging and lab results [FHIR-40514](https://jira.hl7.org/browse/FHIR-40514) [See Changes Here](#.html)
1. **Resolved - change required:** The CBC is incomplete and has a few results and not a Complete Blood Count.  Please Fix. [FHIR-40521](https://jira.hl7.org/browse/FHIR-40521) [See Changes Here](#.html)
1. **Resolved - change required:** Encounter type value set too limited [FHIR-40546](https://jira.hl7.org/browse/FHIR-40546) [See Changes Here](#.html)
1. **Resolved - change required:** Flag additional USCDI requirements in a computable way [FHIR-40553](https://jira.hl7.org/browse/FHIR-40553) [See Changes Here](#.html)
1. **Resolved - change required:** Condition asserted-date search parameter has incorrect expression [FHIR-40573](https://jira.hl7.org/browse/FHIR-40573) [See Changes Here](#.html)
1. **Resolved - change required:** remove profile from reasonReference profile and use types instead. [FHIR-40656](https://jira.hl7.org/browse/FHIR-40656) [See Changes Here](#.html)
