...
24. **Resolved - change required:**  (Correction) A few grammatical fixes and bad link to STU8 [FHIR-54269](https://jira.hl7.org/browse/FHIR-54269) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/index.html)
...
28. **Resolved - change required:**  (Correction) The text contains a duplicated figure label ""Figure 1"". The repeated text should be removed so that the caption reads: ""Figure 1: Context of US Core within the set of HL7 US FHIR standards."" [FHIR-54369](https://jira.hl7.org/browse/FHIR-54369) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/relationship-with-other-igs.html#comparison-with-international-igs)
29. **Resolved - change required:**  (Correction) When clicking on the "IPA Comparison V1.1.0" link, the page displays the message ""The requested URL was not found on this server."" [FHIR-54370](https://jira.hl7.org/browse/FHIR-54370) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/relationship-with-other-igs.html#relationship-with-other-igs)
30. **Applied:** Non-substantive (Correction) Correct Typos in the Cross Version Comparisons table [FHIR-54387](https://jira.hl7.org/browse/FHIR-54387) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/changes-between-versions.html#cross-version-comparisons)
31. **Resolved - change required:**  (Correction) Typo in US Core Device Profile narrative [FHIR-54388](https://jira.hl7.org/browse/FHIR-54388) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-device.html#:~:text=medical%20medical%20devices)
32. **Resolved - change required:** Non-substantive (Clarification) The ""Writing Clinical Notes"" page is informative, but has conformance language [FHIR-54390](https://jira.hl7.org/browse/FHIR-54390) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/writing-clinical-notes.htm)
33. **Resolved - change required:** Non-substantive (Correction) Correct typos and improve clarity on the "Writing Clinical Notes" page. [FHIR-54396](https://jira.hl7.org/browse/FHIR-54396) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/writing-clinical-notes.html)
34. **Resolved - change required:** Non-substantive (Clarification) UPdate defintion in Device.patient [FHIR-54406](https://jira.hl7.org/browse/FHIR-54406) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-device-definitions.html#key_Device.patient)
35. **Resolved - change required:**  (Correction) Update reference to Must Support Coded Quantity Result  [FHIR-54417](https://jira.hl7.org/browse/FHIR-54417) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-observation-lab.html#mandatory-and-must-support-data-elements)
36. **Resolved - change required:** Compatible, substantive (Enhancement) Remove Must Support Requirement for DocumentReference.attester [FHIR-54563](https://jira.hl7.org/browse/FHIR-54563) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-adi-documentreference.html#profile)
37. **Resolved - change required:**  (Correction) Very minor typo in FamilyMemberHistory Profile [FHIR-54587](https://jira.hl7.org/browse/FHIR-54587) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-familymemberhistory.html#root)
38. **Resolved - change required:**  (Correction) US Core Blood Pressure Profile Guidance Typo [FHIR-54612](https://jira.hl7.org/browse/FHIR-54612) See Changes [Here](https://hl7.org/fhir/us/core/STU6.1/StructureDefinition-us-core-blood-pressure.html#mandatory-and-must-support-data-elements)
39. **Resolved - change required:** Non-substantive (Clarification) Question about us-core-22 constraint [FHIR-54654](https://jira.hl7.org/browse/FHIR-54654) See Changes [Here]()
40. **Resolved - change required:** Non-substantive (Clarification) Should explain what acronym PMO means  [FHIR-54657](https://jira.hl7.org/browse/FHIR-54657) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-pmo-servicerequest.html#root)
41. **Resolved - change required:** Compatible, substantive (Correction) Correct URL for USCore Model Info [FHIR-54705](https://jira.hl7.org/browse/FHIR-54705) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/Library-uscore-9.0.0-model-definition.html)
42. **Resolved - change required:** Non-substantive (Clarification) Cleared definition of Direct Write and Mediated Submission [FHIR-54934](https://jira.hl7.org/browse/FHIR-54934) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/writing-clinical-notes.html#purpose-and-scope)
43. **Resolved - change required:**  (Correction) Typo US Core Device Profile - expiration date [FHIR-54935](https://jira.hl7.org/browse/FHIR-54935) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-device.html#udi--specific-implementation-guidance)
44. **Resolved - change required:** Non-substantive (Enhancement) US Core Device Profile: Medical Device List [FHIR-54939](https://jira.hl7.org/browse/FHIR-54939) See Changes [Here]()
45. **Resolved - change required:** Non-substantive (Clarification) More General Guidance needed to inform about format code [FHIR-54944](https://jira.hl7.org/browse/FHIR-54944) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-adi-documentreference.html)
46. **Resolved - change required:** Non-substantive (Correction) please add plain language summary [FHIR-54948](https://jira.hl7.org/browse/FHIR-54948) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/index.html)
47. **Resolved - change required:** Non-substantive (Clarification) More guidance needed for what to represent in Requester field. [FHIR-54949](https://jira.hl7.org/browse/FHIR-54949) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-pmo-servicerequest.html)
48. **Resolved - change required:**  (Correction) Fix Jira spec [FHIR-55391](https://jira.hl7.org/browse/FHIR-55391) See Changes [Here]()
49. **Resolved - change required:**  (Correction) fix grammar [FHIR-55411](https://jira.hl7.org/browse/FHIR-55411) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/index.html)
50. **Resolved - change required:** Compatible, substantive (Enhancement)  New Requirements Table page and Resources. [FHIR-55464](https://jira.hl7.org/browse/FHIR-55464) See Changes:
    ...
    -  [US Core Client Requirements](Requirements-us-core-client.html)
51. **Resolved - change required:** Compatible, substantive (Enhancement) Remove US Core PMO ServiceRequest Profile and use US Core ServiceRequest [FHIR-55597](https://jira.hl7.org/browse/FHIR-55597), [FHIR-53919](https://jira.hl7.org/browse/FHIR-53919) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-pmo-servicerequest.html)
52. **Pre-Applied:**  Change the preferred binding  for RelatedPerson.relationship VSAC Personal And Legal Relationship Role Type [FHIR-53376](https://jira.hl7.org/browse/FHIR-53376) See Changes [Here](StructureDefinition-us-core-relatedperson-definitions.html#RelatedPerson.relationship)
53. **Triaged:**  () Update Race and Ethnicity Valueset [FHIR-53784](https://jira.hl7.org/browse/FHIR-53784) See Changes [Here](https://hl7.org/fhir/us/core/STU6.1/ValueSet-omb-race-category.html)
54. **Triaged:**  () Alignment with OMB Statistical Policy Directive No. 15 (SPD‑15, 2024 revisions) for race and ethnicity standards. [FHIR-53792](https://jira.hl7.org/browse/FHIR-53792) See Changes [Here](https://hl7.org/fhir/us/core/StructureDefinition-us-core-race.html)
55. **Triaged:** Non-substantive (Clarification) Clarification on PMO formats [FHIR-53823](https://jira.hl7.org/browse/FHIR-53823) See Changes [Here]()
56. **Triaged:** Compatible, substantive (Correction) ElementDefinition mappings refer to missing StructureDefinition mappings [FHIR-54105](https://jira.hl7.org/browse/FHIR-54105) See Changes [Here]()
57. **Pre-Applied:** Non-substantive (Clarification) Update Basic Provenance Figure 3 and 4 [FHIR-54222](https://jira.hl7.org/browse/FHIR-54222) See Changes
...
58. **Triaged:**  () Writing Vital Signs Encounter Determination [FHIR-54227](https://jira.hl7.org/browse/FHIR-54227) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/writing-vital-signs.html#observation-elements)
59. **Triaged:** Non-substantive (Clarification) Need clarification of Additional USCDI Requirements [FHIR-54247](https://jira.hl7.org/browse/FHIR-54247) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-servicerequest.html#mandatory-and-must-support-data-elements)
60. **Re-open:** Non-substantive (Enhancement) Limit US Core Goal Codes ValueSet definition to clinical SNOMED CT and LOINC hierarchies. [FHIR-54407](https://jira.hl7.org/browse/FHIR-54407) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/ValueSet-us-core-goal-description.html)
61. **Triaged:**  () Include category concepts in Detailed Ethnicity value set [FHIR-54410](https://jira.hl7.org/browse/FHIR-54410) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-ethnicity.html)
62. **Triaged:**  () HSLOC not appropriate for USCDI facility location [FHIR-54411](https://jira.hl7.org/browse/FHIR-54411) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-location.html)
63. **Triaged:**  () Update HealthcareServiceLocation value set to remove concepts not applicable to Encounter Location.  [FHIR-54412](https://jira.hl7.org/browse/FHIR-54412) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-location.html)
64. **Applied:** Non-substantive (Correction) Change text from "NUBC Place of Service" to "CMS Place of Service" [FHIR-54414](https://jira.hl7.org/browse/FHIR-54414) See Changes [Here](StructureDefinition-us-core-location.html#profile-specific-implementation-guidance)
65. **Triaged:**  () US Core Procedure Code value set definition should not include all LOINC concepts [FHIR-54415](https://jira.hl7.org/browse/FHIR-54415) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/ValueSet-us-core-procedure-code.html)
66. **Triaged:**  () Update profile specific implementation guidance for RelatedPerson.address [FHIR-54435](https://jira.hl7.org/browse/FHIR-54435) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-relatedperson.html#profile-specific-implementation-guidance)
67. **Triaged:** Non-substantive (Enhancement) Clarify profile specific implementation guidance for Patient.address  [FHIR-54437](https://jira.hl7.org/browse/FHIR-54437) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-patient.html)
68. **Applied:**  Non-substantive (Clarification) Update introduction to the US Core ADI DocumentReference Profile. [FHIR-54936](https://jira.hl7.org/browse/FHIR-54936) See Changes [Here](StructureDefinition-us-core-adi-documentreference.html#mandatory-and-must-support-data-elements)
69. **Triaged:** Non-substantive (Correction) Unusual constraint language on backbone element [FHIR-54943](https://jira.hl7.org/browse/FHIR-54943) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-adi-documentreference.html)
70. **Triaged:** Non-compatible (Correction) Review use of additional bindings [FHIR-55688](https://jira.hl7.org/browse/FHIR-55688) See Changes [Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-location-definitions.html#Location.type)
71. **Triaged:**  () US Core DocumentReference Scope Clarification [FHIR-55691](https://jira.hl7.org/browse/FHIR-55691) See Changes [Here](https://hl7.org/fhir/us/core/2026Jan/StructureDefinition-us-core-documentreference.html)
72. **Submitted:**  () HCPCS URI does not resolve [FHIR-55689](https://jira.hl7.org/browse/FHIR-55689) See Changes [Here]()
