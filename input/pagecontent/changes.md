...
1. **Resolved - change required:** (Confusing for commercial vendor.  Reads very confusing.) FHIR-30783 [153067] (https://jira.hl7.org/browse/153067) See Changes [Here](#)
2. **Resolved - change required:** (AllergyIntolerance does not show constraint) FHIR-34636 [173880] (https://jira.hl7.org/browse/173880) See Changes [Here](#)
3. **Resolved - change required:** (Add link in history page to approved pages) FHIR-42950 [218544] (https://jira.hl7.org/browse/218544) See Changes [Here](#)
4. **Resolved - change required:** (Override built-in examples for address elements) FHIR-43054 [219078] (https://jira.hl7.org/browse/219078) See Changes [Here](#)
5. **Triaged:** (All lab orders and results across all FHIR IGs need to indicate the performing laboratory test order name and/or performing laboratory test result name) FHIR-43301 [219534] (https://jira.hl7.org/browse/219534) See Changes [Here](#)
6. **Resolved - change required:** (Seems like observation-category CodeSystem needs to be extended to include a concept for care-experience-preference) FHIR-43541 [223591] (https://jira.hl7.org/browse/223591) See Changes [Here](#)
7. **Resolved - change required:** (Smoking Status Max Binding addition) FHIR-43589 [223689] (https://jira.hl7.org/browse/223689) See Changes [Here](#)
8. **Triaged:** (Create new section in Guidance on Sex and Gender in USCore) FHIR-44115 [225007] (https://jira.hl7.org/browse/225007) See Changes [Here](#)
9. **Triaged:** (US Core Coverage Profile) FHIR-44122 [225018] (https://jira.hl7.org/browse/225018) See Changes [Here](#)
10. **Triaged:** (US Core Coverage.Type Code Link Update ) FHIR-44124 [225024] (https://jira.hl7.org/browse/225024) See Changes [Here](#)
11. **Triaged:** (US Core Terminology Reference List # 62) FHIR-44138 [225049] (https://jira.hl7.org/browse/225049) See Changes [Here](#)
12. **Triaged:** (Source of Payment Typology (SOPT) references and information are incorrect) FHIR-44145 [225066] (https://jira.hl7.org/browse/225066) See Changes [Here](#)
13. **Resolved - change required:** (Make Must Support Reference Table more visible) FHIR-44977 [229822] (https://jira.hl7.org/browse/229822) See Changes [Here](#)
14. **Triaged:** (ValueSet for Condition.code ICD9 link does not resolve) FHIR-45136 [230134] (https://jira.hl7.org/browse/230134) See Changes [Here](#)
15. **Triaged:** (Add requirements for client reference resolution) FHIR-45179 [230253] (https://jira.hl7.org/browse/230253) See Changes [Here](#)
16. **Resolved - change required:** (Clarify Clinical Information Reconciliation and Incorporation (CIRI) description) FHIR-45267 [230508] (https://jira.hl7.org/browse/230508) See Changes [Here](#)
17. **Resolved - change required:** (Remove dated footnote from Provenance page.) FHIR-45283 [232568] (https://jira.hl7.org/browse/232568) See Changes [Here](#)
18. **Triaged:** (add link to Da Vinci SNOMED NUCC mapping to practionerrole page as additional guidance) FHIR-45286 [232582] (https://jira.hl7.org/browse/232582) See Changes [Here](#)
19. **Resolved - change required:** (Clarify Observation Screening Assessment category must support) FHIR-45319 [232641] (https://jira.hl7.org/browse/232641) See Changes [Here](#)
20. **Triaged:** (Clarify must-support requirements for requestors, especially for dateTime) FHIR-45448 [232885] (https://jira.hl7.org/browse/232885) See Changes [Here](#)
21. **Triaged:** (Spelling errors in US Core Server Capability Statement) FHIR-45451 [232888] (https://jira.hl7.org/browse/232888) See Changes [Here](#)
22. **Triaged:** (PHINVADS links broken) FHIR-45494 [232949] (https://jira.hl7.org/browse/232949) See Changes [Here](#)
23. **Resolved - change required:** (Change Average Blood Pressure Profile minimum from 0 to 1) FHIR-45724 [233380] (https://jira.hl7.org/browse/233380) See Changes [Here](#)
24. **Resolved - change required:** (Move ""time-period"" from Must Support to Must Have section in introduction.) FHIR-45726 [233383] (https://jira.hl7.org/browse/233383) See Changes [Here](#)
25. **Resolved - change required:** (Align the Sig description in the medication profile introductions.) FHIR-45951 [235310] (https://jira.hl7.org/browse/235310) See Changes [Here](#)
26. **Triaged:** (Typo in Condition's granular scope) FHIR-45961 [235320] (https://jira.hl7.org/browse/235320) See Changes [Here](#)
27. **Triaged:** (clarify expectations for US@ for health systems) FHIR-46020 [235471] (https://jira.hl7.org/browse/235471) See Changes [Here](#)
28. **Triaged:** (""Must Support"" should be ""Additional USCDI"" for Simple Observation) FHIR-46028 [235481] (https://jira.hl7.org/browse/235481) See Changes [Here](#)
29. **Resolved - change required:** (Derive composite search parameters for derived normal parameters) FHIR-46036 [235493] (https://jira.hl7.org/browse/235493) See Changes [Here](#)
30. **Resolved - change required:** (Procedure.code should be Procedure.performed) FHIR-46037 [235495] (https://jira.hl7.org/browse/235495) See Changes [Here](#)
31. **Triaged:** (US Core Screening Assessment Observation Category in US Core v7) FHIR-46052 [235524] (https://jira.hl7.org/browse/235524) See Changes [Here](#)
32. **Resolved - change required:** (Deprecate every version before 3.1.1 ) FHIR-46065 [235542] (https://jira.hl7.org/browse/235542) See Changes [Here](#)
33. **Triaged:** (Is the Provenance Quick Start API Correct?) FHIR-46077 [235562] (https://jira.hl7.org/browse/235562) See Changes [Here](#)
34. **Resolved - change required:** (Incorrect Examples) FHIR-46099 [235597] (https://jira.hl7.org/browse/235597) See Changes [Here](#)
35. **Triaged:** (Continue to harmonize/share value sets used in US Core and C-CDA in the US Core 8.0 ballot and C-CDA 4.0 ballot) FHIR-46181 [235730] (https://jira.hl7.org/browse/235730) See Changes [Here](#)
36. **Triaged:** (NAIC Code Number Identifier system not registered in THO) FHIR-46185 [235737] (https://jira.hl7.org/browse/235737) See Changes [Here](#)
37. **Triaged:** (Discharge Disposition - US Core and C-CDA need to change to point to THO set ) FHIR-46194 [235749] (https://jira.hl7.org/browse/235749) See Changes [Here](#)
38. **Resolved - change required:** (Clarify (reduce) the media.link requirements for DiagnosticReport (Report and Notes)) FHIR-46240 [235819] (https://jira.hl7.org/browse/235819) See Changes [Here](#)
39. **Resolved - change required:** (Update and Corrections to 2 sets contained in Medication Clinical Drug) FHIR-46255 [235845] (https://jira.hl7.org/browse/235845) See Changes [Here](#)
40. **Resolved - change required:** (Change US Core Pregnancy Status Codes to a soon to be created new value set in VSAC with CLD US Core current defintion) FHIR-46257 [235850] (https://jira.hl7.org/browse/235850) See Changes [Here](#)
41. **Resolved - change required:** (Allow CMS Place of Service codes @location.type in US Core Location Profile) FHIR-46258 [235851] (https://jira.hl7.org/browse/235851) See Changes [Here](#)
42. **Triaged:** (Align Encounter Type between C-CDA and FHIR US Core) FHIR-46259 [235852] (https://jira.hl7.org/browse/235852) See Changes [Here](#)
43. **Resolved - change required:** (Change Binding at observation.value in Pregnancy Intention to VSAC set) FHIR-46263 [236066] (https://jira.hl7.org/browse/236066) See Changes [Here](#)
44. **Resolved - change required:** (Add SDOH Goals value set as ""Additional Binding"" in Goal Profile) FHIR-46266 [236069] (https://jira.hl7.org/browse/236069) See Changes [Here](#)
45. **Triaged:** (US Core Survey Codes expansion error) FHIR-46272 [236076] (https://jira.hl7.org/browse/236076) See Changes [Here](#)
46. **Resolved - change required:** (Clarify the level of granular scopes server shall support) FHIR-46277 [236081] (https://jira.hl7.org/browse/236081) See Changes [Here](#)
47. **Resolved - change required:** (Conflict requirements for SMART App Launch) FHIR-46279 [236083] (https://jira.hl7.org/browse/236083) See Changes [Here](#)
48. **Resolved - change required:** (Survey Codes Set - Refine and change binding to VSAC set) FHIR-46347 [236250] (https://jira.hl7.org/browse/236250) See Changes [Here](#)
49. **Resolved - change required:** (reference specific version of USCDI for each version of USCore) FHIR-46466 [236427] (https://jira.hl7.org/browse/236427) See Changes [Here](#)
50. **Resolved - change required:** (change page status) FHIR-46514 [236498] (https://jira.hl7.org/browse/236498) See Changes [Here](#)
51. **Triaged:** (US Core detailed ethnicity expansion error) FHIR-46638 [237270] (https://jira.hl7.org/browse/237270) See Changes [Here](#)
52. **Resolved - change required:** (how to handle overlapping granular scopes overlap? How can US Core better anticipate UX impact of scopes?) FHIR-46748 [240801] (https://jira.hl7.org/browse/240801) See Changes [Here](#)
53. **Triaged:** (Fix the US Core History Page) FHIR-46749 [240803] (https://jira.hl7.org/browse/240803) See Changes [Here](#)
54. **Triaged:** (Create SCT Specimen Condition concept value set to be use as an additional binding) FHIR-47061 [241469] (https://jira.hl7.org/browse/241469) See Changes [Here](#)
55. **Resolved - change required:** (clarify conformance requirements for structured assessments) FHIR-47139 [241624] (https://jira.hl7.org/browse/241624) See Changes [Here](#)
56. **Resolved - change required:** (Point to new THO Discharge Disposition (NUBC) instead of US Core based set) FHIR-47416 [242738] (https://jira.hl7.org/browse/242738) See Changes [Here](#)
57. **Resolved - change required:** (Tighten constraint on name.use to support better patient matching ) FHIR-48416 [247128] (https://jira.hl7.org/browse/247128) See Changes [Here](#)
58. **Resolved - change required:** (RelatedPerson ""active"" is required) FHIR-48439 [247157] (https://jira.hl7.org/browse/247157) See Changes [Here](#)
59. **Triaged:** (Update Must Support Resource References section in general and for Observation.performer targets) FHIR-48442 [247160] (https://jira.hl7.org/browse/247160) See Changes [Here](#)
60. **Resolved - change required:** (Add USCDI v5 Data Elements to US Core) FHIR-48443 [247161] (https://jira.hl7.org/browse/247161) See Changes [Here](#)
61. **Resolved - change required:** (Remove contradictory guidance on reference resolution in US Core) FHIR-48446 [247164] (https://jira.hl7.org/browse/247164) See Changes [Here](#)
62. **Triaged:** (Update last_updated SHOULDS to SHALLS) FHIR-48542 [247336] (https://jira.hl7.org/browse/247336) See Changes [Here](#)
63. **Triaged:** (Update US Core Clinical Note Type Valueset to align with Clinical Note Guidance) FHIR-48607 [247411] (https://jira.hl7.org/browse/247411) See Changes [Here](#)
64. **Triaged:** (Update Terminology guidance to align with USCDI) FHIR-48668 [247519] (https://jira.hl7.org/browse/247519) See Changes [Here](#)
