...
7. **Submitted:** Patient Search Parameter Clarification gender/gender-identity [FHIR-42783](https://jira.hl7.org/browse/FHIR-42783) [See Changes Here](#.html)
8. **Submitted:** Clarify Coverage status [FHIR-42777](https://jira.hl7.org/browse/FHIR-42777) [See Changes Here](#.html)
9. **Triaged:** Allow references to other entities for Subject/Patient elements [FHIR-42759](https://jira.hl7.org/browse/FHIR-42759) [See Changes Here](#.html)
10. **Submitted:** ""Datetime must be at least to day"" regex rejects valid dateTimes with the required precision [FHIR-42738](https://jira.hl7.org/browse/FHIR-42738) [See Changes Here](#.html)
11. **Triaged:** Add USCDI Version 4 Data Elements to US Core [FHIR-42161](https://jira.hl7.org/browse/FHIR-42161) [See Changes Here](#.html)
12. **Triaged:** remove option 3 from SNOMED US Edition guidance [FHIR-42160](https://jira.hl7.org/browse/FHIR-42160) [See Changes Here](#.html)
13. **Triaged:** Reason for Referral support for basedOn(ServiceRequest) [FHIR-42136](https://jira.hl7.org/browse/FHIR-42136) [See Changes Here](#.html)
14. **Triaged:** USCDI - FHIR US Core Relationship Clarification [FHIR-42130](https://jira.hl7.org/browse/FHIR-42130) [See Changes Here](#.html)
15. **Triaged:** Add Job Center to US Core Provider Role Value Set [FHIR-42092](https://jira.hl7.org/browse/FHIR-42092) [See Changes Here](#.html)
16. **Triaged:** Da Vinci DTR Variance Request:  QuestionnaireResponse & ServiceRequest not in US Core 3.1.1 [FHIR-42071](https://jira.hl7.org/browse/FHIR-42071) [See Changes Here](#.html)
17. **Triaged:** Typo in Blood Pressure [FHIR-42069](https://jira.hl7.org/browse/FHIR-42069) [See Changes Here](#.html)
18. **Triaged:** Clarify the R4 base spec & US Core guidance on DocumentReference [FHIR-41902](https://jira.hl7.org/browse/FHIR-41902) [See Changes Here](#.html)
19. **Triaged:** limit context for jurisdiction extension [FHIR-41867](https://jira.hl7.org/browse/FHIR-41867) [See Changes Here](#.html)
20. **Triaged:** Expand ability to capture reason for the procedure [FHIR-41761](https://jira.hl7.org/browse/FHIR-41761) [See Changes Here](#.html)
21. **Triaged:** Exception for CRD Coverage [FHIR-41752](https://jira.hl7.org/browse/FHIR-41752) [See Changes Here](#.html)
22. **Triaged:** Exception for CRD ServiceRequest [FHIR-41737](https://jira.hl7.org/browse/FHIR-41737) [See Changes Here](#.html)
23. **Triaged:** Excel downloads missing header row [FHIR-41709](https://jira.hl7.org/browse/FHIR-41709) [See Changes Here](#.html)
24. **Triaged:** Add VSAC Value Sets to Terminology Page [FHIR-41681](https://jira.hl7.org/browse/FHIR-41681) [See Changes Here](#.html)
25. **Triaged:** 'activity' category should allow supervision by clinician [FHIR-41672](https://jira.hl7.org/browse/FHIR-41672) [See Changes Here](#.html)
26. **Triaged:** APGAR should be Apgar [FHIR-41666](https://jira.hl7.org/browse/FHIR-41666) [See Changes Here](#.html)
27. **Resolved - change required:** Correct invalid invariants pd-1 and us-core-13 [FHIR-41586](https://jira.hl7.org/browse/FHIR-41586) [See Changes Here](#.html)
28. **Triaged:** Remove USCDI marker for Patient.gender [FHIR-41572](https://jira.hl7.org/browse/FHIR-41572) [See Changes Here](#.html)
29. **Triaged:** Change ASKU in value set to asked-declined [FHIR-41571](https://jira.hl7.org/browse/FHIR-41571) [See Changes Here](#.html)
30. **Triaged:** Create a table of VSAC Valueset on the Terminology page [FHIR-41506](https://jira.hl7.org/browse/FHIR-41506) [See Changes Here](#.html)
31. **Triaged:** Unable to include additional values in Occupation or Industry [FHIR-41364](https://jira.hl7.org/browse/FHIR-41364) [See Changes Here](#.html)
32. **Triaged:** Patient race should allow more than one [FHIR-41359](https://jira.hl7.org/browse/FHIR-41359) [See Changes Here](#.html)
33. **Triaged:** update canonical urls in examples and capability statements to include the version [FHIR-41256](https://jira.hl7.org/browse/FHIR-41256) [See Changes Here](#.html)
34. **Triaged:** Condition profile descriptions are not appearing in IG Detailed Description Snapshot View (other places) [FHIR-40813](https://jira.hl7.org/browse/FHIR-40813) [See Changes Here](#.html)
35. **Triaged:** Preferred Language vs Communication Language [FHIR-40773](https://jira.hl7.org/browse/FHIR-40773) [See Changes Here](#.html)
36. **Triaged:** Clarify that support for search by POST is mandatory [FHIR-40641](https://jira.hl7.org/browse/FHIR-40641) [See Changes Here](#.html)
37. **Triaged:** update UCUM guidance [FHIR-40604](https://jira.hl7.org/browse/FHIR-40604) [See Changes Here](#.html)
38. **Triaged:** BirthSex in US Core Patient refers to Administrative Gender Code System [FHIR-40588](https://jira.hl7.org/browse/FHIR-40588) [See Changes Here](#.html)
39. **Triaged:** Patch Request: Patient.us-core-ethnicity does not allow for nullFlavors in value set [FHIR-40309](https://jira.hl7.org/browse/FHIR-40309) [See Changes Here](#.html)
40. **Triaged:** Abnormal lab examples should carry interpretation [FHIR-40297](https://jira.hl7.org/browse/FHIR-40297) [See Changes Here](#.html)
41. **Resolved - change required:** RelatedPerson relationshiptype should have binding to FHIR value set RelatedPerson-relationshiptype [FHIR-34755](https://jira.hl7.org/browse/FHIR-34755) [See Changes Here](#.html)
42. **Resolved - change required:** AllergyIntolerance does not show constraint [FHIR-34636](https://jira.hl7.org/browse/FHIR-34636) [See Changes Here](#.html)
43. **Resolved - change required:** Several Vital Signs missing from CapabilityStatement US Core Server page [FHIR-34478](https://jira.hl7.org/browse/FHIR-34478) [See Changes Here](#.html)
44. **Resolved - change required:** Confusing for commercial vendor.  Reads very confusing. [FHIR-30783](https://jira.hl7.org/browse/FHIR-30783) [See Changes Here](#.html)
45. **Resolved - change required:** In most of the data elements – “Binding is from base FHIR and US Core Vital Signs”  Need this to be one single combined listing [FHIR-30780](https://jira.hl7.org/browse/FHIR-30780) [See Changes Here](#.html)
46. **Resolved - change required:** valueset-simple-language.xml QA Error [FHIR-30107](https://jira.hl7.org/browse/FHIR-30107) [See Changes Here](#.html)
47. **Resolved - change required:** Patient Examples QA Errors: CDCREC code system in VSAC [FHIR-30105](https://jira.hl7.org/browse/FHIR-30105) [See Changes Here](#.html)
