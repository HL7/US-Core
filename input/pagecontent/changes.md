...
5. **Triaged:** Add Past Medical History and Chief Complaint to condition types. - USCore #150 [FHIR-20127](https://jira.hl7.org/browse/FHIR-20127) [See Changes Here](#)
6. **Triaged:** Consider adding years since quite smoking - USCore #154 [FHIR-20131](https://jira.hl7.org/browse/FHIR-20131) [See Changes Here](#)
7. **Triaged:** Specify that the us-core-county extension should be used only when both district and county are required [FHIR-20657](https://jira.hl7.org/browse/FHIR-20657) [See Changes Here](#)
...
38. **Triaged:** us-core-6 invariant [FHIR-37704](https://jira.hl7.org/browse/FHIR-37704) [See Changes Here](#)
...
40. **Submitted:** Patient.name invariant seems incorrect [FHIR-37725](https://jira.hl7.org/browse/FHIR-37725) [See Changes Here](#)
41. **Submitted:** US Core CapabilityStatement does not have supportedProfile for US Core Encounter [FHIR-37766](https://jira.hl7.org/browse/FHIR-37766) [See Changes Here](#)
42. **Triaged:** US Core Diagnostic Report Category element is not usable as is [FHIR-37770](https://jira.hl7.org/browse/FHIR-37770) [See Changes Here](#)
43. **Resolved - change required:** Does US Core 5 require SMARTv2 ? [FHIR-37813](https://jira.hl7.org/browse/FHIR-37813) [See Changes Here](#)
44. **Applied:** Typo of ""DiagnostisReport"" in Clinical Notes Guidance [FHIR-37819](https://jira.hl7.org/browse/FHIR-37819) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/clinical-notes.html)
...
49. **Applied:** Typo in Condition Problems and Health Concerns search example [FHIR-37929](https://jira.hl7.org/browse/FHIR-37929) [See Changes Here](https://build.fhir.org/ig/HL7/US-Core/StructureDefinition-us-core-condition-problems-health-concerns.html)
...
52. **Resolved - change required:** update QuickStart to include all the search requirements by type. [FHIR-38629](https://jira.hl7.org/browse/FHIR-38629) [See Changes Here](#)
53. **Triaged:** specify $docref's OperationDefinition.resource to be DocumentReference [FHIR-38658](https://jira.hl7.org/browse/FHIR-38658) [See Changes Here](#)
