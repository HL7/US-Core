...
<span class="bg-success" markdown="1">> If an extensible binding is applied to an element with maximum cardinality > 1, the binding applies to all the elements.(http://hl7.org/fhir/R4/terminologies.html#extensible)</span><!-- new-content -->
