...
<!-- ================================================================
 The following OperationDefinition list is generated by the ig-publisher.
====================================================================== -->
...
- {% if new %}<span data-note="highlight text" class="bg-success" markdown="1">{% endif %}[{{ titlecase | replace_first: 'Us', 'US' | replace: '-', ' '}}]({{resource_hash[1].path}}){% if new %}</span><!-- new-content highlight text -->{% endif %}
            {%- endif -%}
        {%- endunless -%}
    {%- endif -%}
   {%- endfor %}
