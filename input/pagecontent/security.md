...
-   For Authentication and Authorization, Systems **SHALL** support [SMART App Launch] Version 2.0.0 or later for Client <-> Server interactions. NOTE: The SMART App Launch specifications include the required OAuth 2.0 scopes for enabling security decisions.<sup>[§][CONF-0570],[§][CONF-0571]</sup>
