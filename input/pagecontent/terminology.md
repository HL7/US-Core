...
|---|---|---|---|
|<span class="bg-success" markdown="1">`https://www.cms.gov/Medicare/Coding/HCPCSReleaseCodeSets`</span><!-- new-content -->|[CMS](https://www.cms.gov/Medicare/Coding/HCPCSReleaseCodeSets)|*Healthcare Common Procedure Coding System (HCPCS) level II alphanumeric codes*|2.16.840.1.113883.6.285|
