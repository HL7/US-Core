This folder contains project specific source conformance resource in YAML format.  These are converted to JSON format and add/overwrite to the resource in the resources folder by a custom bash script:
