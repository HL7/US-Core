...
- Note that this profile represents a *percentile* observation, for representing the raw OFC measurements use the FHIR Vital Signs [Head Circumference] Profile.
