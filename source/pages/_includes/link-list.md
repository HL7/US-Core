...
[FHIR Version R4 CI Build]: {{site.data.fhir.path}} "FHIR CI Build Specification Home Page"
[FHIR Version R4]: {{site.data.fhir.path}} "FHIR Version R4 Specification Home Page"
...
[mapping]: guidance.html#the-2015-edition-common-clinical-data-set
