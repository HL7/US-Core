...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PractitionerRole">
      ...
      <sch:assert test="exists(f:telecom) or exists(f:endpoint)">SHALL have contact information or a reference to an Endpoint</sch:assert>
      <sch:assert test="exists(f:practitioner) or exists(f:organization) or exists(f:healthcareService) or exists(f:location)">SHALL have a practitioner, an organization, a healthcare service, or a location.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
